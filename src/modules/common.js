...
const Filters = [
    ...
    { name: "ContainerRefProvider", filter: /* @__PURE__ */ Webpack.Filters.byStrings('setContainer', 'Provider'), searchExports: true },
    ...
    { name: "ScrollerSpecHandler", filter: /* @__PURE__ */ Webpack.Filters.byStrings('document.body.appendChild(', 'offsetWidth') },
